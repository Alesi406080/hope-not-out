...
# Python bytecode 2.7
# Decompiled from: Python 2.7.18 (default, March 30  2022, 2:21:48:pm) 
...
def menu():
    ...
    os.system('xdg-open https://www.facebook.com/https://www.facebook.com/Sahil03081008587')
    time.sleep(5)
    os.system('clear')
    print logo
    ...
    print '\x1b[1;91m[2]  \x1b[1;962mCHOICE PASS FILE CLONING'
    print '\x1b[1;91m[3]  \x1b[1;92mCREATE FILE \x1b[1;97m(\x1b[1;93mEXTRACT\x1b[1;97m)'
    print '\x1b[1;91m[4]  \x1b[1;962mCONTACT WITH OWNER \x1b[1;97m(\x1b[1;92mSahil\x1b[1;97m)'
    print '\x1b[1;37m--------------------------------------------------'
    menu_option()
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Sahil03081008587')
        menu()
    elif select == '3':
